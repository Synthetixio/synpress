 ...
 * 
 */
export default class EntitiesSpreadWidget {

  getWidgetName() {
    return 'Entities Spread'
  }

  getCloseWidgetButton() {
    return cy.xpath('//div[contains(@class, "flexlayout__tab_button_content") and contains(text(), "Entities Spread")]//following-sibling::div')
  }
}