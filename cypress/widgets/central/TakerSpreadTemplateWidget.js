 ...
 * 
 */
export default class TakerSpreadTemplateWidget {

  getWidgetName() {
    return 'Taker Spread Templates'
  }

  getCloseWidgetButton() {
    return cy.xpath('//div[contains(@class, "flexlayout__tab_button_content") and contains(text(), "Taker Spread Templates")]//following-sibling::div')
  }
}