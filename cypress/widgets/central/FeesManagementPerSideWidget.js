 ...
 * 
 */
export default class FeesManagementPerSideWidget {

  getWidgetName() {
    return 'Fees Management (Per side)'
  }

  getCloseWidgetButton() {
    return cy.xpath('//div[contains(@class, "flexlayout__tab_button_content") and contains(text(), "Fees Management (Per side)")]//following-sibling::div')
  }
}