...
test('should import account using private key', async ({ page, metamask }) => {
  await metamask.importWalletFromPrivateKey('0xea084c575a01e2bbefcca3db101eaeab1d8af15554640a510c73692db24d0a6a')
