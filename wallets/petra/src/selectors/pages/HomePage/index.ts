...
const addNewAccountMenu = {
  ...
  createButton: `button${createDataTestSelector(
    "primary-button"
  )}:has-text("Create")`,
};

const renameAccountMenu = {
  saveButton: `button${createDataTestSelector(
    "primary-button"
  )}:has-text("Save")`,
};
...
const importAccountMenu = {
  networkOpenMenu:
    '[aria-haspopup="listbox"][role="button"]:has-text("Solana")',
...
const addAccountMenu = {
  ...
  createNewAccountButton: createDataTestSelector(
...
const accountMenu = {
  ...
  manageAccountsButton: createDataTestSelector(
    "sidebar_menu-button-manage_accounts"
  ),
...
export default {
  solanaWalletAddress: createDataTestSelector(
    "account-header-chain-solana:101"
  ),
  ethereumWalletAddress: createDataTestSelector(
    "account-header-chain-eip155:1"
  ),
  baseWalletAddress: createDataTestSelector("account-header-chain-eip155:8453"),
  polygonWalletAddress: createDataTestSelector(
    "account-header-chain-eip155:137"
  ),
  bitcoinWalletAddress: createDataTestSelector(
    "account-header-chain-bip122:000000000019d6689c085ae165831e93"
  ),
  ...
  headerBackButton: `section:has-text("Developer Settings") ${createDataTestSelector(
    "header--back"
  )}`,
  settings,
  accountMenu,
