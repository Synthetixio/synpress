...
- [GitHub Discussions](https://github.com/Synthetixio/synpress/discussions) =>
...
**Tip:** It is recommended to keep all E2E test environment variables in their
own `.env` file to avoid name collision and for separation of concerns. This is
easily achievable using env-cmd.
